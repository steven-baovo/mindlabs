...
const ZenEditor = ({ initialContent, onChange, placeholder = 'Bắt đầu viết...' }: ZenEditorProps) => {
  ...
  return (
    <div className="relative w-full">
      ...
      {menuPos && (
        <div 
          className="fixed z-[100] flex items-center gap-1 bg-white/95 backdrop-blur-md border border-border-medium p-1.5 rounded-xl animate-in fade-in zoom-in duration-200"
          style={{ 
