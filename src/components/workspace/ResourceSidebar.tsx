        ...
        >
          ...
          {!isCollapsed && (
            <div className="relative flex items-center opacity-0 group-hover:opacity-100 transition-opacity pr-1 z-20">
              ...
              {isMenuOpen && (
                <div 
                  className="absolute right-0 top-full mt-2 w-36 bg-white border border-border-main -premium rounded-2xl p-1.5 z-[100] animate-in fade-in zoom-in slide-in-from-top-2 duration-200"
                  onClick={(e) => e.stopPropagation()}
                >
          ...
          >
            ...
            {!props.isCollapsed && (
              <div className="relative flex items-center opacity-0 group-hover:opacity-100 transition-opacity pr-1 z-20">
                ...
                {isMenuOpen && (
                  <div 
                    className="absolute right-0 top-full mt-2 w-48 bg-white border border-border-main -premium rounded-2xl p-1.5 z-[100] animate-in fade-in zoom-in slide-in-from-top-2 duration-200"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <button
                      onClick={(e) => {
    ...
    >
      ...
      <div className="p-4 px-2 pb-2">
        {isCollapsed ? (
          <div className="flex flex-col items-center relative">
            ...
            {isCreateMenuOpen && (
              <div 
                className="absolute right-full mr-2 top-0 bg-white border border-[#f5f5f5] rounded-xl p-1.5 flex flex-col gap-1 z-[100] w-36 animate-in fade-in zoom-in slide-in-from-right-2 duration-200"
                onClick={(e) => e.stopPropagation()}
              >
      ...
      {deletingId && (
        <div className="absolute inset-0 z-[200] bg-white/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-white border border-border-main -premium rounded-2xl p-4 w-full animate-in zoom-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="w-full py-2 bg-red-500 text-white rounded-xl text-[11px] font-bold hover:bg-red-600 transition-colors"
              >
                Xác nhận xóa
              </button>
              <button
